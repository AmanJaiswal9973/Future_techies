...
const Hero: React.FC<HeroProps> = ({ onJoinClick, onNavigate }) => {
  return (
    <section
      id="home"
      className="relative min-h-screen pt-32 sm:pt-28 flex items-center justify-center overflow-hidden"
    >
      {/* Background Gradient */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Master <span className="text-blue-300">Programming</span> &<br />
            Build Your <span className="text-purple-300">Future</span>
          </h1>
